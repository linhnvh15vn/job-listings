...
export default function Tag({
  ...
  const variants = {
    default: `h-8 bg-primary/10 text-base leading-8 text-primary hover:bg-primary hover:text-white ${
      allowedRemove ? 'rounded-l-md' : 'rounded-md'
    }`,
    primary: 'h-6 rounded-3xl bg-primary text-sm leading-6 text-white',
    accent: 'h-6 rounded-3xl bg-foreground text-sm leading-6 text-white',
  };
